...
function  Checkout() {
    return ( 
      ...
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        ...
        <form className='bg-white px-5 py-12 mt-6'>
  ...
  <div className="mx-auto mt-6 bg-white max-w-4xl px-0  sm:px-6 lg:px-4">
       ...
       <h1 className="text-4xl my-2 font-bold tracking-tight text-gray-900">Cart</h1>
                     ...
                     Qty
                       ...
                       <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                         ...
                         <div className='mt-6'>
                          <Link to="/pay" className='flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 '>
                            Pay and Order
                          </Link>
                         </div>
